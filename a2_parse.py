...
with open(infile) as fh:
	...
	for line in fh:
		...
		if edgeid not in edges:
			...
			edges[edgeid]['HRtest_p'] = cols[8]
			edges[edgeid]['Pr_adjusted'] = cols[9]
...
for id in edges:
	datalist.append(" {{data:{{id:'{}',source:'{}',target:'{}',valueN:{},valuePrAdjusted:{},valueexp_coef:{},pHRtest:{}}}}}".format(id, edges[id]['source'], edges[id]['target'], edges[id]['N'],edges[id]['Pr_adjusted'],edges[id]['exp_coef'],edges[id]['HRtest_p']))
